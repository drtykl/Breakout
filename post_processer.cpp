...
PostProcessor::PostProcessor(Shader shader, unsigned int width, unsigned int height)
	: PostProcessingShader(shader), Texture(), Width(width), Height(height), Confuse(false), Chaos(false), Shake(false),Remove(false)
{
	...
	//4 is internal format,GL_TRIANGLES,and multisample for MSFBO
...
void PostProcessor::Render(float time)
{
	...
	this->PostProcessingShader.SetInteger("remove", this->Remove);
